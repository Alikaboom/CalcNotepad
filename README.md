...
Selection Tool
The selection tool is currently in an experimental phase. While the core functionality exists, users may encounter inconsistent behavior. Development priority was focused on the refinement of the OCR processing pipeline and mathematical expression evaluation to ensure calculation accuracy.